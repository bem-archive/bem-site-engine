...
//TODO здесь нужно что-то сделать с целью добиться большей абстрактности
...
в значении для данного поля. При сборке данных, к данному узлу динамически будет достроено дерево состояшщее из узлов описывающих текущие скомпилированные версии библиотеки,
